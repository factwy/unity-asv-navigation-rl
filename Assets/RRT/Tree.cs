...
namespace RRT
{
    ...
    public class Tree
    {
        ...
        /// </param>
        public Tree(Vector3 startPos, RRT rrtController)
        {
            RootNode = new Node(startPos);
            _rrtController = rrtController;
        }
        ...
        public Node TargetNode
        {
            ...
            set
            {
                _targetNode = value;
                HasFoundPath = true;
                // 경로를 찾았음을 RRT 컨트롤러에게 알림
                if (_rrtController != null) _rrtController.NotifyPathFound(); 
            }
        }
