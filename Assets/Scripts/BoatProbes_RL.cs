...
{
    /// <summary>
    /// Boat physics for Reinforcement Learning system.
    /// Uses multiplicative AI input scaling.
    /// </summary>
    [AddComponentMenu(Internal.Constants.MENU_PREFIX_SCRIPTS + "Boat Probes RL")]
    public class BoatProbes_RL : BoatProbesBase
    {
        /// <summary>
